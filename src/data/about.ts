...
export const chefStory = {
  ...
  body2:
    "In 2018, he partnered with hospitality veteran Elena Voss to open Ember & Oak. The concept was simple but uncompromising: source the finest beef available, age it with precision, cook it over genuine flame, and surround it with service so attentive it becomes invisible.",
  body3:
...
export const timeline: TimelineEntry[] = [
  { year: "2016", event: "Marcus Hale and Elena Voss conceptualize Ember & Oak after a year of research across Europe and Japan." },
  { year: "2017", event: "The team acquires a landmark Second Avenue building and begins an 18-month renovation." },
  { year: "2018", event: "Ember & Oak opens its doors. Within three months, the restaurant earns a place on Seattle Magazine\u2019s Best New Restaurants list." },
...
export const aboutHero = {
  ...
  body: "Ember & Oak was born from a belief that Seattle deserved a steakhouse as ambitious as the city itself.",
};
